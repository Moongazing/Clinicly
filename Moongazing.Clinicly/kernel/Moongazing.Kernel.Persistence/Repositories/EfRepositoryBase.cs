    ...
    where TContext : DbContext
{
    ...
    public async Task BulkInsertOrUpdateOrDeleteAsync(ICollection<TEntity> entities)
    {
        using var transaction = await Context.Database.BeginTransactionAsync();

        try
        {
            await Context.BulkInsertOrUpdateOrDeleteAsync(entities, new BulkConfig
            {
    ...
    public async Task BulkInsertOrUpdateAsync(ICollection<TEntity> entities)
    {
        using var transaction = await Context.Database.BeginTransactionAsync();
